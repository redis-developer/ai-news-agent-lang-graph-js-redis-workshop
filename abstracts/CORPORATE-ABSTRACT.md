...
All enriched data—content, summaries, metadata, timestamps, and embeddings—will be stored in **Redis** and indexed through **Redis Search**. This creates a unified memory layer that supports hybrid search and real-time contextualization, making it easy for agents to work with large and frequently updated datasets.
